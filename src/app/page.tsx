  ...
  return (
    <div className={isDarkMode ? styles.darkMode : styles.lightMode}>
      <div className={styles.buttonContainer}>
        ...
        <Toggle isDarkMode={isDarkMode} handleDarkMode={handleDarkMode} />
        <button
          type="button"
        ...
        {showModal && <AddForm filteredData={filteredData} setFilteredData={setFilteredData} setShowModal={setShowModal}/>}
        </div>
